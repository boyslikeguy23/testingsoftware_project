...
public class TicketActionTest {
    ...
    public void testTicketPayment() throws InterruptedException {
        webDriver.navigate().to(eventWithPaymentURL); // Context la Navigate den thang su kien luon
    ...
    @Test
    public void paymentWrongInfomation() throws InterruptedException {
        webDriver.navigate().to(eventWithPaymentURL); // Context la Navigate den thang su kien luon
        WebElement loginButton = webDriver.findElement(By.xpath("//span[contains(text(), 'Đăng nhập | Đăng ký')]"));
        loginButton.click();
        Thread.sleep(2000);
        ...
        continueButtonAfterFormFilling.click();
        Thread.sleep(2000);
        // day la phan can code tiep
        WebElement creditcardRadioButton = webDriver.findElement(By.xpath("//input[@type='radio']["));
        // Click the first radio button
